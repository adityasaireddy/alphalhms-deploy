...
const Hero = () => {
  return (
    <div className="relative h-[45vh] w-full">
      <div className="absolute inset-0 bg-gradient-to-b from-green-800/10 to-green-800/55 dark:from-green-700/15 dark:to-green-800/40" />
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 py-2">Providing Placement Support with Top MNC</p>
        </div>
      </div>
    </div>
  );
